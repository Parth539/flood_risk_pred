...
## 👥 Team Roles *(Adjust based on your actual team)*

- **Data Engineer:** GEE data collection and preprocessing
- **ML Engineer:** Model development and evaluation
- **Backend Developer:** API and server setup
- **Frontend Developer:** Web UI and interaction
- **Project Manager:** Integration, testing, and coordination
